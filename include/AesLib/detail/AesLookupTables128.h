...
/* Invserse S-Box */
constexpr const static uint8_t inv_s[0x100] = {
...
/* S-Box multiplied by 2 for encryption */
constexpr const static uint8_t sbox_mul2[0x100] = {
...
/* S-Box multiplied by 3 for encryption */
constexpr const static uint8_t sbox_mul3[0x100] = {
...
constexpr const static uint8_t rcon[0x100] = {
...
constexpr const static uint8_t mul2[0x100] = {
...
constexpr const static uint8_t mul3[0x100] = {
...
/* Multiply by 9 for UnmixColumns */
constexpr const static uint8_t mul9[0x100] = {
...
/* Multiply by 11 for UnmixColumns */
constexpr const static uint8_t mul11[0x100] = {
...
/* Multiply by 13 for UnmixColumns */
constexpr const static uint8_t mul13[0x100] = {
...
/* Multiply by 14 for UnmixColumns */
constexpr const static uint8_t mul14[0x100] = {
...
static constexpr uint32_t T_Table0[] = {
...
static constexpr uint32_t T_Table1[] = {
...
static constexpr uint32_t T_Table2[] = {
...
static constexpr uint32_t T_Table3[] = {
...
static constexpr uint32_t T_TableInv0[] = {
...
static constexpr uint32_t T_TableInv1[] = {
...
static constexpr uint32_t T_TableInv2[] = {
...
static constexpr uint32_t T_TableInv3[] = {
